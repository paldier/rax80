...
#if defined(_CFE_) && !defined(CONFIG_BCM96856)
...
void mac_hwapi_get_tx_max_frame_len(rdpa_emac emacNum,uint32_t *maxTxFrameLen )
{
    ...
    uintptr_t address = (uintptr_t)UNIMAC_TOP_UNIMAC_MISC_UNIMAC_EXT_CFG1 + ( UNIMAC_MISC_EMAC_OFFSET * emacNum );
...
void mac_hwapi_set_unimac_cfg(rdpa_emac emacNum, int32_t enabled)
{
    ...
    uintptr_t address = (uintptr_t)UNIMAC_TOP_UNIMAC_MISC_UNIMAC_CFG + ( UNIMAC_MISC_EMAC_OFFSET * emacNum );
...
void mac_hwapi_modify_flow_control_pause_pkt_addr ( rdpa_emac emacNum,bdmf_mac_t mac)
{
    ...
    uintptr_t mac_address = (uintptr_t)UNIMAC_CONFIGURATION_UMAC_0_RDP_MAC0 + ( UNIMAC_CONF_EMAC_OFFSET * emacNum );
    ...
    mac_address = (uintptr_t)UNIMAC_CONFIGURATION_UMAC_0_RDP_MAC1 + ( UNIMAC_CONF_EMAC_OFFSET * emacNum );
...
void mac_hwapi_set_backpressure_ext(rdpa_emac emacNum,int32_t enable)
{
    ...
    uintptr_t misc_top_address = (uintptr_t)UNIMAC_TOP_UNIMAC_MISC_UNIMAC_EXT_CFG2 + ( UNIMAC_MISC_EMAC_OFFSET * emacNum );
