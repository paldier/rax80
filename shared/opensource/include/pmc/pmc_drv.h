...
#define PMB_BUS_CRYPTO           1
#define PMB_ADDR_CRYPTO          (5 | PMB_BUS_CRYPTO << PMB_BUS_ID_SHIFT)
...
#define PMB_BUS_SGMII           1
#define PMB_ADDR_SGMII          (7 | PMB_BUS_SGMII << PMB_BUS_ID_SHIFT)
...
#define PMB_ADDR_XRDP_RC3         (17 | PMB_BUS_XRDP_RC3 << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_XRDP_RC3        1

#define PMB_BUS_XRDP_RC4          1
#define PMB_ADDR_XRDP_RC4         (22 | PMB_BUS_XRDP_RC4 << PMB_BUS_ID_SHIFT)
#define PMB_ZONES_XRDP_RC4        1

#define PMB_BUS_XRDP_RC5          1
#define PMB_ADDR_XRDP_RC5         (23 | PMB_BUS_XRDP_RC5 << PMB_BUS_ID_SHIFT)
...
#endif  /* defined(_BCM96836_) || defined(CONFIG_BCM96836)  */
...
#define BPCM_PHY_CNTL_OFFSET           0x2C
#define BPCM_AFEREG_BGBIAS_CNTL_OFFSET 0x30
...
void WaitPmc(int runState);
    ...
    defined(CONFIG_BCM96858) || defined(_BCM94908_)       || defined(CONFIG_BCM94908)  || defined(_BCM96836_)       || defined(CONFIG_BCM96836)  || \
