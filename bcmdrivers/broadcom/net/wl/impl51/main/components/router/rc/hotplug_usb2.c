...
#if defined(R6300v2) || defined(R7000) || defined(R8000) || defined(BCA_HNDROUTER)
...
#elif defined(R7800) || defined(AX6000)
...
#elif defined(R7000) || defined(R8000) || defined(BCA_HNDROUTER)
...
int usb_dual_led(void)
{
    ...
    usb1_led();
   /* foxconn added by Kathy @ No USB2 LED for R7900 */
#ifdef CONFIG_PRODUCT_ALIAS
	if(!acosNvramConfig_match("hwver","R7900"))
		usb2_led();
#endif
    return rtn_val;
} /* usb_dual_led() */
