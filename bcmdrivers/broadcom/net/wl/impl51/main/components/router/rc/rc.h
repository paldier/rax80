 ...
 *
 * $Id: rc.h 766522 2018-08-06 05:05:21Z $
 */
...
/*foxconn Han edited, 05/18/2015*/
    ...
    #define isTriBand() (nvram_match("hwver",TRI_BAND_HW_VER) || nvram_match("hwver",TRI_BAND_HW_VER_ALIAS)) /* Foxconn modified by Max Ding, 12/21/2016 @fix 5g-2 wifi not work issue in vlan/iptv case */
    #else /* !CONFIG_PRODUCT_ALIAS */
    #define isTriBand() (nvram_match("hwver",TRI_BAND_HW_VER))
...
#define ORANGE_INTERNET_ISP     "0"
#define OTHER_ISP               "1"
#define ORANGE_IPTV_ISP         "2"
#define ORANGE_INTERNET_VLAN_ID      "835"
#define ORANGE_INTERNET_PRIORITY     "0"
#define ORANGE_IPTV_V4_VLAN_ID       "838"
#define ORANGE_IPTV_V4_PRIORITY      "4"
#define ORANGE_IPTV_V6_VLAN_ID       "840"
#define ORANGE_IPTV_V6_PRIORITY      "5"
#define ORANGE_IPTV_NAME             "Orange_France_IPTV/VOD"
#define ORANGE_IPTV_NAME_GUI         "Orange France IPTV/VOD"
#define ORANGE_IPTV_PORTS            "0x4" /* set port 3 for Orange IPTV according to spec v2a */
#endif
typedef struct vlan_rule_t{
    char vlan_name[C_MAX_TOKEN_SIZE]; /* Foxconn modified by Max Ding, 11/22/2016 @sync with network_util.h */
    char vlan_id[6];
    char vlan_prio[4];
    char vlan_ports[10];
    char enable_rule[4];
...
#define IPTV_WLAN2              0x20
    ...
    #define IPTV_WLAN_GUEST_ALL     (IPTV_WLAN_GUEST1 | IPTV_WLAN_GUEST2 | IPTV_WLAN_GUEST3) 
#else
    #define IPTV_WLAN_ALL           (IPTV_WLAN1 | IPTV_WLAN2)   //0x30
    #define IPTV_WLAN_GUEST_ALL     (IPTV_WLAN_GUEST1 | IPTV_WLAN_GUEST2) 
#endif
    #if defined(AX6000)
    #define IPTV_LAN5               0x400
    #define IPTV_LAN_ALL            (IPTV_LAN1 | IPTV_LAN2 | IPTV_LAN3 | IPTV_LAN4 | IPTV_LAN5)
    #elif defined(CONFIG_2ND_SWITCH)
    #define IPTV_LAN5               0x400
    #define IPTV_LAN6               0x800
    #define IPTV_LAN_ALL            (IPTV_LAN1 | IPTV_LAN2 | IPTV_LAN3 | IPTV_LAN4 | IPTV_LAN5 | IPTV_LAN6)
    ...
    #else
    #define IPTV_LAN_ALL            (IPTV_LAN1 | IPTV_LAN2 | IPTV_LAN3 | IPTV_LAN4)
    #endif

    #define IPTV_MASK               (IPTV_LAN_ALL | IPTV_WLAN_ALL | IPTV_WLAN_GUEST_ALL) 
