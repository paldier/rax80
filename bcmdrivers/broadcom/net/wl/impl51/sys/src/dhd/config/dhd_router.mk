...
DHDIFLAGS       += -I$(SRCBASE)/../../$(SRCBASE_DHD)/../components/awd/include
...
DHDIFLAGS       += -I$(SRCBASE_ROUTER)/bcmdrv/include
ifeq ($(CONFIG_BCM_HOSTAPD),y)
...
DHDIFLAGS       += -I$(SRCBASE_ROUTER)/dpsta
...
DHDFILES_SRC    += src/dhd/sys/dhd_cfg_vendor.c
DHDFILES_SRC    += src/wl/sys/wl_cfg80211.c
DHDFILES_SRC    += src/wl/sys/wl_cfgp2p.c
DHDFILES_SRC    += src/wl/sys/wl_cfgvendor.c
