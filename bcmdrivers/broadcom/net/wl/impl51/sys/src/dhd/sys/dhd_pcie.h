 ...
 *
 * $Id: dhd_pcie.h 754155 2018-03-26 07:53:39Z $
 */
...
typedef struct dhd_bus {
	...
	/* PCIe IPC : Local copy of IPC and Rings structures fetched from dongle */
	uint32      pcie_ipc_revision;
	...
	uint8 force_suspend;
	uint32 psm_run; /* PSM_RUN bit prior to halting dongle, bitmap, bit0 is for PSMr */
	bool   idma_enabled;
	bool   ifrm_enabled;
	uint32 ifrm_index_num_per_group; /* number of wr index in one group */
} dhd_bus_t;
