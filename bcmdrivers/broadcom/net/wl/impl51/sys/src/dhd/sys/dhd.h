 ...
 *
 * $Id: dhd.h 766880 2018-08-20 01:56:26Z $
 */
...
#if defined(NDIS)
#if (NDISVER >= 0x0600)
#define dhd_os_open_image(dhdpub, a) wl_os_open_image(a)
#define dhd_os_close_image(dhdpub, a) wl_os_close_image(a)
...
bool dhd_rx_pkt_integrity(dhd_pub_t *dhdp, int ifidx);
#endif /* HNDCTF */
#if defined(BCM_GMAC3)
bool dhd_if_fwder_capable(dhd_pub_t *dhdp, int ifidx);
#endif /* BCM_GMAC3 */
...
extern void dhd_schedule_trap_log_dump(dhd_pub_t *dhdp, bool isup);
...
void dhd_os_ind_firmware_stall(dhd_pub_t *dhd);
#else
